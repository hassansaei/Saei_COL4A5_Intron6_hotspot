...
- `01_alphagenome_analysis/`  
  ...
  ISM workflow in `COL4A5_ISM/`). See `01_alphagenome_analysis/README.md` and
  `01_alphagenome_analysis/COL4A5_ISM/README.md`.
...
- Gene/transcript definitions: COL4A5 `NM_033380.3` (plus paralogs COL4A3 `NM_000091.5`, COL4A4 `NM_000092.5`) via the UCSC `ncbiRefSeq` table; introns extracted with `01_alphagenome_analysis/COL4A5_ISM/extract_introns.py`
...
4. `01_alphagenome_analysis/COL4A5_ISM/alphagenome_ISM_COL4A5_batch.ipynb` (full-gene batch ISM; run after `extract_introns.py`)
